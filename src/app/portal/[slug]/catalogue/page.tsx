...
const fallback = (slug: string): any => ({
  ...
  primary_color: "#1a3a2e", accent_color: "#c8e63c",
...
export default async function CataloguePage({ params }: { params: { slug: string } }) {
  ...
  // Catalogue IS the home page — render same component
