  ...
  if (!token) return (
    <AuthLayout title="Invalid link" subtitle="This reset link is missing or malformed">
      <div style={{ textAlign: "center" }}>
        ...
        <p style={{ fontSize: 14, color: "var(--az-muted)", marginBottom: 24 }}>Please request a new password reset link.</p>
        <Link href="/forgot-password" style={{ display: "inline-block", padding: "11px 24px", borderRadius: 8, background: "var(--az-navy)", color: "#ffffff", fontWeight: 700, textDecoration: "none", fontSize: 14 }}>
          Request new link
        </Link>
      </div>
    </AuthLayout>
  ...
  if (done) return (
    <AuthLayout title="Password updated" subtitle="You can now sign in with your new password">
      <div style={{ textAlign: "center" }}>
        ...
        <p style={{ fontSize: 15, color: "var(--az-muted)", marginBottom: 8 }}>Password updated successfully.</p>
        <p style={{ fontSize: 13, color: "var(--az-muted)" }}>Redirecting to sign in…</p>
      </div>
    </AuthLayout>
  );
      ...
      <form onSubmit={handleSubmit} noValidate>
        ...
        <div style={{ display: "grid", gap: 16, marginBottom: 24 }}>
          ...
          <div>
            ...
            <input type="password" required autoComplete="new-password"
              style={{ ...inp, borderColor: form.confirm && form.confirm !== form.password ? "var(--az-red)" : "var(--az-line)" }}
        ...
        <button type="submit" disabled={loading}
          style={{
            ...
            background: loading ? "var(--az-line)" : "var(--az-navy)", color: loading ? "var(--az-muted)" : "#ffffff",
